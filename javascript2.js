...
var aText = new Array(
    "Du lịch là trải nghiệm, đến là khám phá,",
    "là đón nhận nhưng cần có trách nhiệm với thế giới nơi đây",
    "để không làm thay đổi những điều tốt đẹp vốn có",
    "<span style='color: yellow'>và để mỗi đứa trẻ đều có tuổi thơ trọn vẹn.</span>"
);
